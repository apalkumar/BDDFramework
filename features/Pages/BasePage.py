...
class BasePage:
    ...
    def get_element(self, locator_type, locator_value):
        ...
        if locator_type.endswith("_name"):
    ...
    def retrieved_element_text_should_contain(self, locator_type, locator_value, expected_text):
        element = self.get_element(locator_type, locator_value)
        return element.text.__contains__(expected_text)

    def retrieved_element_text_should_equals(self, locator_type, locator_value, expected_text):
        element = self.get_element(locator_type, locator_value)
